...
{
	[ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(IntroduceAndInitializeLocalFieldCodeRefactoringProvider)), Shared]
	internal class IntroduceAndInitializeLocalFieldCodeRefactoringProvider : CodeRefactoringProvider
	{
